...
tinyMCE.init({
        ...
        // Theme options
        theme_advanced_buttons1 : "bold,italic,underline,strikethrough,|,justifyleft,justifycenter,justifyright,justifyfull,|,styleselect,formatselect,fontselect,fontsizeselect,syntaxhl",
...
<form action="save" method="POST">
	...
	<div style="width:550px">
		<script src="https://gist.github.com/3925113.js"> </script>	
	</div>
	<div class="myClass">
		${post.author}
	</div>
